...
static const char *TAG = "DJTME_BLUETOOTH_S3";
...
static void ble_app_on_sync(void) {
    ...
    ble_svc_gap_device_name_set("DJTME_BLUETOOTH_S3");

    struct ble_hs_adv_fields fields = {};
    fields.flags = BLE_HS_ADV_F_DISC_GEN | BLE_HS_ADV_F_BREDR_UNSUP;
    fields.name = (uint8_t *)"DJTME_BLUETOOTH_S3";
    fields.name_len = strlen("DJTME_BLUETOOTH_S3");
